...
class NvwaPriceTab:
    ...
    def _init_ui(self):
        ...
        # 控制按钮 - 使用更现代的按钮样式
        refresh_btn = ttk.Button(control_frame, text="刷新", command=self.refresh_nvwa_price, style="Unified.TButton", width=6)
        ...
        auto_refresh_cb = ttk.Checkbutton(control_frame, text="自动刷新", variable=self._auto_refresh_var, 
                       command=self.auto_refresh_nvwa_price, style="Unified.TCheckbutton")
